...
public abstract class GNCarouselBase extends Control {
    ...
    public GNCarouselBase() {
        ...
        this.setPrefWidth(200D);
                ...
                this.transitionDuration = new SimpleStyleableObjectProperty<>(StyleableProperties.TRANSITION_DURATION, this, "transitionDuration", Duration.millis(1500D));
    ...
    public String getUserAgentStylesheet() {
        return GNCarouselBase.class.getResource("/CarrouselEvenement/carouselEvenement.css").toExternalForm();
    }
    ...
    private StyleableProperties(){}
        ...
        static {
            ...
            TRANSITION_DURATION = new CssMetaData<GNCarouselBase, Duration>("-gn-transition-duration", DurationConverter.getInstance(), Duration.millis(3000D)) {
